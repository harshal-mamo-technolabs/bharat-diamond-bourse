...
export default function CorporateTaxSection() {
  ...
  return (
    <section className="relative w-full py-10 sm:py-10">
      <div className="">
        <motion.div 
          className="flex flex-col mx-auto px-4 md:px-8 lg:px-16 xl:px-32 gap-4 sm:gap-6 lg:gap-10 bg-[#ecf3f7] p-4 sm:p-6 lg:p-8 rounded-md relative"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true }}
          variants={containerVariants}
        >
          {/* Content Row - Icon and Paragraph */}
          <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6 lg:gap-10">
            {/* Left Side - Small Info Icon */}
            <div className="flex-shrink-0 flex justify-start md:justify-center sm:justify-start w-full sm:w-auto">
          ...
          <div className="flex justify-end w-full mt-0">
            <button className="bg-white text-[#05183A] hover:bg-[#05183A] hover:text-white p-4 rounded-none transition-colors duration-200">
