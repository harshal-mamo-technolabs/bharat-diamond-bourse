    ...
    <section className="w-full bg-white py-10">
      <div className="mx-auto px-4 md:px-8 lg:px-16 xl:px-32 grid grid-cols-12 gap-8 items-center">
        ...
        <div className="col-span-12 md:col-span-6">
          ...
          <h3 className={`text-[32px] md:text-[50px] leading-[1.1] text-[#0E234E] font-bold mb-6 ${gothamLight.className}`}>Daimond co.</h3>
          <div className={`space-y-5 text-[#364153] text-[16px] text-justify ${sora.className}`}>
            <p>
          ...
          <div className="mt-8">
            <button
              className={[
                ...
                'px-6 py-3 text-[12px] sm:px-1 sm:py-2 sm:text-[13px]',
            ...
            >
              Learn More
              <Arrow color="#0E234E" size={18} stroke={2} className="transition-transform duration-300 group-hover:translate-x-1" />
            </button>
          </div>
        </div>
