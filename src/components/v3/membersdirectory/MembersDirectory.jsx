...
const memberData = [
  {
    ...
    image: '/members-directory/member-1.png',
    QBC1: "9584",
    QBC2: "26754288",
  ...
  },
  {
    ...
    profession: 'Office No: GW6021',
    location: 'GW6021, Bharat Diamond Bourse, G- Block, Bandra Kurla Complex, BKC, Bandra-East, Mumbai-400051',
    image: '/members-directory/member-2.png',
    QBC1: "9584",
    QBC2: "26754288",
    officeNo: '+91 22 1234 5678',
    contactNo: '+91 98765 43210',
  ...
  },
  {
    ...
    profession: 'Office No: GW6021',
    location: 'GW6021, Bharat Diamond Bourse, G- Block, Bandra Kurla Complex, BKC, Bandra-East, Mumbai-400051',
    image: '/members-directory/member-3.png',
    QBC1: "9584",
    QBC2: "26754288",
    officeNo: '+91 22 1234 5678',
    contactNo: '+91 98765 43210',
              ...
              >
                ...
                <div className="mt-4 space-y-1.5">
                  ...
                  <div className="flex items-center gap-2">
                    <FaMapMarkerAlt className="text-[#05183A] text-sm w-6 h-6" />
                    <span className={`text-[#05183A] text-sm sm:text-[13px] ${sora.className}`}>
                      {member.location}
                    </span>
                  </div>
