          ...
          <div className="bg-[#F2F4F6]/15 rounded-md p-6 sm:p-10 sm:pt-20 relative mb-20 overflow-visible">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-y-12 md:gap-y-0 md:gap-x-10 items-start">
              ...
              <div className="max-w-xl">
                <h2
                  className={`text-3xl sm:text-4xl font-bold text-[#1D3156] mb-4 ${gothamLight.className}`}
                >
                  WHO WE ARE
                </h2>
                <p
              ...
              <div className="max-w-xl ml-auto flex flex-col justify-end">
                <h2
                  className={`text-3xl sm:text-4xl font-bold text-[#1D3156] mb-3 ${gothamLight.className}`}
                >
                  MISSION & VISION
                </h2>
                <p
