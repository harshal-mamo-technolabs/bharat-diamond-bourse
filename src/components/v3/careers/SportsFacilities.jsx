...
const SportsFacilities = () => {
  ...
  const facilities = [
    {
      title: "Diamond grading workshops",
      image: "/career/career-1.png",
      subtitle:"Mental health support, fitness memberships, and wellness events."
    },
    {
      title: "Jewellery design courses",
      image: "/career/career-2.png",
      subtitle:"Parental leave, childcare support, and flexible family policies."
    },
    {
      title: "Industry seminars and webinars",
      image: "/career/career-3.png",
      subtitle:"Team outings, events, and celebrations to foster connection."
    },
  ];
                  ...
                  >
                    <div className="relative h-64 md:h-80 rounded-lg overflow-hidden">
                      ...
                      <div className="absolute bottom-3 left-3 right-3">
                        <h4 className={`text-white font-medium text-sm md:text-[30px] leading-tight ${sora.className}`}>
                          {facility.title}
                        </h4>
                        <p className={`${sora.className} text-white text-[13px]`}>{facility.subtitle}</p>
                      </div>
                    </div>
                  </motion.div>
                ))}
