  ...
  return (
    <section className="relative w-full py-4 sm:py-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-6">
        <motion.div 
          className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6 lg:gap-10 bg-[#EFF3F6] p-4 sm:p-6 lg:p-8 rounded-none relative"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true }}
        ...
        >
          ...
          <div className="flex-1 sm:mb-0 lg:mb-12">
            <p className={`text-[#05183A] text-[14px] sm:text-[15px] lg:text-[17px] leading-relaxed ${sora.className}`}>
