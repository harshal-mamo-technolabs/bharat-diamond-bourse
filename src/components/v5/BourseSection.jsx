                ...
                <div className="mx-auto px-4 md:px-8 lg:px-16 xl:px-32">
                    ...
                    >
                        ...
                        <motion.h2
                            ...
                            transition={{ duration: timings.header, ease }}
                            className={`${gothamLight.className} text-[#0E234E] text-center text-[22px] sm:text-[24px] lg:text-[30px] tracking-[0.08em] uppercase mb-6 lg:mb-7`}
                        >
                                    ...
                                    whileHover={
                                        reduce
                                            ...
                                            : {
                                                y: -4,
                                                boxShadow:
                                                    "0 8px 18px rgba(14,35,78,0.10), 0 2px 6px rgba(14,35,78,0.06)",
